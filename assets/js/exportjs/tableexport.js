...
;(function (window, undefined) {
    ...
    $.fn.tableExport = function (options) {
        ...
        return this.each(function () {
            ...
            function checkCaption(exportButton) {
                var $caption = $('#hdbtnexport');
					$caption.length ? $caption.append(exportButton) : $el.prepend('<caption class="' + bootstrapSpacing + settings.position + ' xlsx_caption">' + exportButton + '</caption>');
            }
    ...
    $.fn.tableExport.defaults = {
        ...
        formats: ["xlsx", "xls", "csv", "txt"],           // (String[]), filetype for the export, (default: ["xls", "csv", "txt"])
